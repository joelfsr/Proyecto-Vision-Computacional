    ...
    if bg is not None:
        ...
        for cnt in cnts:
            ...
            if defects is not None:
                ...
                if fingers == 0:
                    cv2.putText(frame, 'Oxigeno', (320, 45), 1, 2, (color_fingers), 2, cv2.LINE_AA)
                else:
                    if fingers ==1:
                        cv2.putText(frame, 'Agua', (300, 45), 1, 2, (color_fingers), 2, cv2.LINE_AA)

                    else:
                        if fingers == 2:
                            if angulo > 60:
                                cv2.putText(frame, 'Policia', (300, 45), 1, 2, (color_fingers), 2, cv2.LINE_AA)
                            else:
                                if angulo<40:
                                    cv2.putText(frame, 'Bomberos', (300, 45), 1, 2, (color_fingers), 2, cv2.LINE_AA)
                        else:
                            if fingers == 3:
                                cv2.putText(frame, 'Ambulancia', (300, 45), 1, 2, (color_fingers), 2, cv2.LINE_AA)
                            else:
                                if fingers == 4:
                                    cv2.putText(frame, 'Bomberos', (300, 45), 1, 2, (color_fingers), 2, cv2.LINE_AA)
                                else:
                                    cv2.putText(frame, 'Oxigeno', (300, 45), 1, 2, (color_fingers), 2, cv2.LINE_AA)
